            ...
            return (
                  <div>
                        {typeof initials[fieldType] === 'object' ? (
                              ...
                              <>
                                    {Object.keys(initials[fieldType]).length !==
                                          0 && (
                                          <>
                                                <h3 className="bg-green-300 text-teal-950">
                                                      {fieldType}
                                                </h3>
                                                {Object.keys(
                                                      initials[fieldType]
                                                                              ...
                                                                              (
                                                                                    ...
                                                                                    <>
                                                                                          ...
                                                                                          <input
                                                                                                ...
                                                                                                name={`${fieldType}.${nestedKey}.${mediaKey}`}
                                                                                                type="text"
                                                                                                placeholder={
                                                                                                      mediaKey
                                                                                                }
